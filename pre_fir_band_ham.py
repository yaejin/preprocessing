...
save_dir = '/Users/yaejin/Documents/2023_1/PDC/CLNet-main 2/pre_fir_ham5/'
...
def worker(name, labels):
    ...
    for k in tqdm(range(len(labels)), desc=name, file=sys.stdout):
        ...
        signal, _, _ = st.filter_signal(signal, ftype='FIR', band='bandpass', order=100,
